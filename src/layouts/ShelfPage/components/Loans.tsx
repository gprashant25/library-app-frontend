...
import ShelfCurrenLoans from "../../../models/ShelfCurrentLoans";
...
export const Loans = () => {
    ...
    // Current Loans
    const [shelfCurrentLoans, setShelfCurrentLoans] = useState<ShelfCurrenLoans[]>([]);
    ...
    useEffect(() => {
        ...
        // this means each time this useEffect is called, we essentially scroll to the top of the page
        window.scrollTo(0, 0);
    ...
    return (
        ...
        <div>
            ...
            <div className="d-none d-lg-block mt-2">
                ...
                {/* below we're making sure that the endpoint ie the REST API returned atleast one current loan */}
                                        ...
                                        <div className="card-body">
                                            <div className="mt-3">
                                                ...
                                                <div className='list-group mt-3'>
                                                    ...
                                                    <Link className='list-group-item list-group-item-action' to={'/search'} >Search more books?</Link>
