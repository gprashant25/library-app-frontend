...
export const ShelfPage = () => {
    ...
    // here we're going to force a new useEffect upload each time the history page opens up 
    // so here we are connected by state and everytime the history button is clicked then the returned book list is populated.
                ...
                <nav>
                    ...
                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button onClick={() => setHistoryClick(false)} className="nav-link active" id="nav-loans-tab" data-bs-toggle='tab' 
                            data-bs-target='#nav-loans' type="button" role="tab" aria-controls="tab-loans"
                            aria-selected='true'>
                                Loans
                        </button>
