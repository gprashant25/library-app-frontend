...
export const PaymentPage = () => {
    ...
    // STRIPE PAYMENT PART:  pay fees part
    const elements = useElements();
    const stripe = useStripe();

    // below is a asynchronous function bcos we're going to be calling Stripe and our API
    async function checkout() {

        // below checking if all customer card details are filled properly
        ...
        // STRIPE PAYMENT PART: Now here we need to confirm our Card payment using STRIPE. 
        // here we're calling our API endpoint for our payment complete. While Stripe is also doing what it needs to do for the payment to be complete.
        stripe.confirmCardPayment(
            ...
            if(result.error) {
                ...
                setSubmitDisabled(false);
                alert('There was an error found')
                ...
                // here if we didn't get any error then it means that the Stripe payment is successfully done and the payment details of specific user payment detail got successfully updated in database as well. hence writing setFees(0);
                setFees(0);
                setSubmitDisabled(false);
                ...
                fees > 0  && <div className='card mt-3'>
                    ...
                    <div className='card-body'>
                        ...
                        <button disabled={submitDisabled} type='button' 
                            className='btn btn-md main-color text-white mt-3' onClick={checkout}>
                            Pay fees
                        </button>
                    </div>
