...
export const ManageLibraryPage = () => {
    ...
    // Please Note: here we want to make sure that we're checking the user type or the role to see that whether the logged in user is a admin user or it a normal user.
    // here below we're checking the user type to see if they're an admin user or not
