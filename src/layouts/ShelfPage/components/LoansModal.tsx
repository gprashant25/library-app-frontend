...
export const LoansModal: React.FC<{ shelfCurrentLoan: ShelfCurrenLoans, mobile: boolean, 
                    ...
                    <div className='modal-body'>
                        <div className='container'>
                            <div className='mt-3'>
                                ...
                                {/* Below code here we want to do the whole finding out what to say based on how many days are left  */}
                                ...
                                <div className='list-group mt-3'>
                                    ...
                                    <button onClick={
                                        props.shelfCurrentLoan.daysLeft < 0 ? 
                                        (event) => event.preventDefault()   // this code means that we will not allow this button to do anything if our shelfCuurentLoan.daysLeft is less than zero
                                        : 
